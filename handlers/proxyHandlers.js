    ...
    if (userData.type === 'admin') {
        ...
        switch(cbData.button) {
            case proxyListMenu.EDIT:
                bot.sendMessage(message.chat.id, `Що ви бажаєте редагувати?`, generateEditProxyMenu(cbData.id));
                break;
            case proxyListMenu.REMOVE:
                bot.sendMessage(message.chat.id, `Ви впевнені що хочете видалити дані проксі?`);
                break;
